...
from angr.calling_conventions import SimRegArg, SimStackArg, SimFunctionArgument, SimStructArg
            ...
            try:
                ...
                tp.update_variable_types(
                    self.function.addr,
                    {
                        ...
                        if isinstance(v, (SimRegisterVariable, SimStackVariable, SimComboRegisterVariable))
                    },
